...
This is a simple CLI study/review tracker , which uses the Retrospective Revision Timetable principle for efficient studying.
...
It has a simple local CSV database.
You can manually change it the way you want.
